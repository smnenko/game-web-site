...
from apps.games.models import Game, Genre, Platform, Screenshot, Musts
from apps.user.models import CustomUser
from gamemuster.tests.games.factories import GameFactory, GenreFactory, PlatformFactory, ScreenshotFactory
from gamemuster.tests.users.factories import CustomUserFactory
